            ...
            modelBuilder.Entity("mikroLinkAPI.Domain.Entities.Randevu", b =>
                {
                    ...
                    b.Property<string>("RandevuZamani")
                        .IsRequired()
                        .HasMaxLength(7)
                        .HasColumnType("nvarchar(7)");
                    ...
                    b.HasIndex("CompanyId", "TeamLeaderId", "RandevuTarihi")
                        .IsUnique()
                        .HasDatabaseName("IDX_UQ_Company_TeamLeader_Randevu");

                    b.HasIndex("CompanyId", "TeamLeaderId", "RandevuTarihi", "RandevuZamani")
                        .IsUnique()
                        .HasDatabaseName("IDX_UQ_Company_TeamLeader_RandevuTarihi");
