...
SELECT ComponentId,girisIrsaliye,saglam,arzali,hurda,raf, (Select Id from dbo.MalzemeTuru where Value=malzemeTuru) as malzemeTuru,{Company},null,null,getdate(),Serinumarasi,{User},6 FROM #TempCsv_[@tempName]; 
